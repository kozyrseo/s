...
(function () {
  ...
  var PARTNERS = [
  {
        ...
        "_score_breakdown": {
              ...
              "_final": 8.2,
              "_trust_notes": [
                    "прямой рум (расчёты с оператором)",
                    "лицензия"
              ]
        }
  },
  {
        ...
        "note": "Приватный клуб в ClubGG. Мягкие поля, расчёты в гривне через Telegram. Welcome-бонус 100% к первому депозиту.",
        "card": {
              "logoText": "K",
        ...
        "_score_breakdown": {
              ...
              "_final": 8.3,
              "_trust_notes": [
                    "клуб через агента (деньги через посредника)",
                    "надёжный софт"
              ]
        }
  },
