...
# Имя автора зависит от языка версии: украинская — «Микита», русская — «Никита».
# Так на украинских площадках автор по-украински, на русских — по-русски.
AUTHOR_NAME_BY_LANG = {"uk": "Микита Волошин", "ru": "Никита Волошин"}
AUTHOR_NAME = "Никита Волошин"  # фолбэк
AUTHOR_URL = f"{SITE}/ua/blog/authors/nikita/"


def _author_for_lang(lang: str) -> str:
    """Имя автора для языка версии (uk → Микита, ru → Никита)."""
    return AUTHOR_NAME_BY_LANG.get(lang, AUTHOR_NAME)
...
def post_one(slug: str, lang: str, platform: str) -> dict:
    ...
    result = reposter.publish(
        ...
        author_name=_author_for_lang(lang),
