...
I18N = {
    "ru": {
            ...
            "pros_title": "✓ Плюсы",
            "cons_title": "− Минусы",
            "reviews_intro": "Мнения игроков об этом руме. Хочешь поделиться опытом — оставь свой отзыв.",
            "play": "Играть",
    ...
    "uk": {
            ...
            "pros_title": "✓ Плюси",
            "cons_title": "− Мінуси",
            "reviews_intro": "Думки гравців про цей рум. Хочеш поділитися досвідом — залиш свій відгук.",
            "play": "Грати",
            "sticky_rb": "Рейкбек до",
