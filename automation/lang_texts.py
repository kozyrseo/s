...
LANG_TEXTS: dict[str, dict] = {
    "pl": {'lang_name_native': 'українській', 'lang_name_ru': 'украинском', 'hero_alt_prefix': 'Ілюстрація до статті:', 'section_room_reviews': 'Огляди румів', 'section_club_reviews': 'Огляди клубів', 'section_rakeback_deals': 'Рейкбек та угоди', 'ui': {'breadcrumb_home': 'Головна', 'breadcrumb_blog': 'Блог', 'article_eyebrow': 'Блог KOZYR', 'min_read': 'хв читання', 'by_author': 'Автор: Микита Волошин', 'author_name': 'Микита Волошин', 'in_this_article': 'У цій статті', 'author_written_by': 'Автор', 'author_role': 'Рейкбек-аналітик · KOZYR', 'author_bio': "Нікіта в онлайн-покері понад 10 років — пройшов шлях від мікролімітів NL2 до регуляра мідстейксу, тому оцінює руми та клуби за тим, що реально бачить за столом, а не за рекламою. У KOZYR рахує ефективний рейкбек, перевіряє м'якість полів, строки та надійність виплат — за даними партнерів, які звіряються з агентами й операторами та оновлюються по мірі змін. Без маркетингового туману й обіцянок «занеси і виграй».", 'last_updated': 'Оновлено', 'author_profile_link': 'Про автора →', 'cta_heading_prefix': 'Шукаєш ', 'cta_heading_suffix': ' з максимальним рейкбеком?', 'cta_paragraph': 'Обери угоду під свій формат і ліміти за 15 секунд — у каталозі KOZYR лише перевірені руми та клуби.', 'cta_button': 'Відкрити каталог', 'related_eyebrow': 'Читати далі', 'related_heading_prefix': 'Схожі матеріали про ', 'related_heading_em': 'рейкбек та руми', 'nav_ai_bot': 'Каталог', 'nav_how': 'Як це працює', 'nav_features': 'Рейкбек', 'nav_compare': 'Порівняння', 'nav_cases': 'Руми', 'nav_reviews': 'Клуби', 'nav_pricing': 'FAQ', 'header_cta': 'Відкрити каталог', 'footer_tagline': 'KOZYR — вітрина рейкбек-угод для покерних гравців. Каталог румів та клубів, чесні умови, прямі партнерські посилання. Рейкбек нараховує та виплачує сам рум/клуб.', 'footer_product_h': 'Розділи', 'footer_company_h': 'Проект', 'footer_link_ai_bot': 'Каталог угод', 'footer_link_nlh': 'PokerBet', 'footer_link_plo': 'KlubOk', 'footer_link_short_deck': 'Порівняння', 'footer_link_compare': 'Порівняння', 'footer_link_cases': 'Блог', 'footer_link_reviews': 'FAQ', 'footer_link_pricing': 'Правова інформація', 'footer_copyright': '© 2026 KOZYR · Вітрина рейкбек-угод · 21+ · Грай відповідально', 'lang_switcher_label': 'RU', 'lang_switcher_aria': 'Перейти на російську версію', 'lang_switcher_target_url': '/ua/', 'fab_label': 'Ми в Telegram', 'fab_aria': 'Відкрити Telegram-канал KOZYR', 'fab_toast': 'Відкриваємо Telegram...', 'fab_tg_msg': 'Привіт! Прийшов з блогу KOZYR — розкажіть про актуальні рейкбек-угоди.', 'skip_link': 'Перейти до основного змісту', 'burger_aria': 'Відкрити меню', 'nav_aria': 'Основна навігація'}},
