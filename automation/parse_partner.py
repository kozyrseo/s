...
- traffic: краткая словесная оценка трафика/живости столов из текста, как есть
  (напр. "высокий, живые столы вечером", "мало игроков днём"). Если не сказано — "".
- traffic_online: примерное ЧИСЛО игроков онлайн, если названо (напр. "~5000 вечером"
  → 5000). Если числа нет — null. НЕ выдумывай число, если его нет в тексте.
- acceptedCountries: коды стран, откуда принимают игроков (ISO-2 в нижнем регистре).
